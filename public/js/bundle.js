...
var AddCharacter = (function (_React$Component) {
    ...
    function AddCharacter(props) {
        ...
        // 如此一来，所有的state都在store里面配置了？完全不用经过view部分了？只有在dom里面出现。
...
var AddCharacterSotre = (function () {
    function AddCharacterSotre() {
        _classCallCheck(this, AddCharacterSotre);
    ...
    _createClass(AddCharacterSotre, [{
    ...
    return AddCharacterSotre;
})();

exports['default'] = _alt2['default'].createStore(AddCharacterSotre);
module.exports = exports['default'];
